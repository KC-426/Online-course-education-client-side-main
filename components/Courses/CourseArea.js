...
const CourseArea = ({ courseData }) => {
  ...
  // const {data:categoryItems,isLoading,error,isError} = useGetCoursesQuery();

  console.log("categoryItems => ", courseData);

  const [categoryFilter, setCategoryFilter] = useState(false);
  const uniqueCategory = [
    ...new Set(courseData?.category?.map((course) => course)), 
  ];
  const [currentPage, setCurrentPage] = useState(1);
  const [coursePerPage, setCoursePerPage] = useState(6);
  const indexOfLastCourse = currentPage * coursePerPage;
  const indexOfFirstCourse = indexOfLastCourse - coursePerPage;
  let courseItems = courseData?.slice(
    categoryFilter ? 0 : indexOfFirstCourse,
    categoryFilter ? categoryItems?.length : indexOfLastCourse
  );
                              ...
                              <div className="course__content p-relative">
                                ...
                                {/* <div className="course__bottom d-sm-flex align-items-center justify-content-between">
                                  <div className="course__tutor">
                                    <a href="#">
                                      <img src={"/default.jpg"} alt="" />{"tutor_name"}
                                    </a>
                                  </div>
                                  ...
                                  <div className="course__right p-relative">
                                    <div className="course__content p-relative">
                                      ...
                                      <div className="course__summary">
                                        <p>
                                          Communia virtutes tutiorem declarat
                                          stoicorum sanabat oblivisci nostris
                                          tamquam iucunditatem
                                        </p>
                                      </div>
          ...
          <div className="row">
            ...
            {!categoryFilter && (
              <Pagination
                ...
                // totalCourse={categoryItems?.courses?.length}
