// import CourseDetailVideos from "../../src/pages/enroll_course/[course_id]"
...
// import CourseDetailVideos from "../CourseDetails/CourseDetailVideos"


const DetailsTabItems = ({data}) => {
   return (
      <>
                        ...
                        <ul>
                           {
                              data?.topic_covered?.map((ele, i) => {
                                 return <li key={i}> <i className="fa-solid fa-check"></i> {ele}</li>
                              })
                           }
