...
const CourseDetails = () => {
  ...
  useEffect(() => {
    if (course?._id && user?.email) {
      fetch(
        `https://eduker-server.onrender.com/paymentInfo?email=${user?.email}&&id=${course?._id}`
      )
        .then((res) => res.json())
        .then((data) => {
  ...
  if (!isLoading && !isError && course?.course?._id) {
    const {
      title,
      blog_active,
      description,
              ...
              <div className="course__wrapper">
                <div className="page__title-content mb-25">
                  ...
                  >
                    {category?.map((ele, i) => {
                      return (
                        <span key={i} className="breadcrumb__title-pre">
                          {ele}
                        </span>
                      );
                    })}
                ...
                <div className="course__meta-2 d-sm-flex align-items-center mb-30">
                  <div className="course__teacher-3 d-flex align-items-center mr-70 mb-30">
                    ...
                    <div className="course__teacher-info-3">
                      ...
                      <p>
                        <a href="#">
                          {courseTeacher ? courseTeacher : "Vikas divyakirti"}
                        </a>
                      </p>
                    </div>
                  </div>
                  <div className="course__update mr-80 mb-30">
                    <h5>Last Update:</h5>
                    <p>
                      {new Date(createdAt).getDate() < 10 ? 0 : ""}
                      {new Date(createdAt).getDate()} /{" "}
                      {new Date(createdAt).getMonth() + 1 < 10 ? 0 : ""}
                 ...
                 <div className="course__rating-inner d-flex align-items-center">
                   ...
                   <p>nahi hai koi review</p>
                 </div>
               </div> */}
                </div>
                <div className="course__img w-img mb-30">
                  <img
                    src={thumb_img?.url ? thumb_img?.url : "/default.jpg"}
                    alt=""
                  />
                </div>

                <DetailsTabItems data={course.course} />
                ...
                <div className="course__sidebar-widget-2 white-bg mb-20">
                  <div className="course__video">
                    ...
                    <div className="course__video-content mb-35">
                      <ul>
                        ...
                        {/* <li className="d-flex align-items-center">
                          ...
                          <div className="course__video-info">
                            <h5>
                              <span>Enrolled :</span>100+ students
                            </h5>
                          </div>
                        </li> */}
                        {/* <li className="d-flex align-items-center">
                    ...
                    <div className="course__enroll-btn">
                      {currentUser && !paymentInformation?.payment ? (
                        <button
                          onClick={handleShow}
                          type="button"
    ...
    <>
      ...
      >
        ...
        {/* <div style="padding:56.25% 0 0 0;position:relative;">
          <iframe
            src="https://player.vimeo.com/video/873591177?badge=0&amp;autopause=0&amp;quality_selector=1&amp;progress_bar=1&amp;player_id=0&amp;app_id=58479"
            frameBorder="0"
