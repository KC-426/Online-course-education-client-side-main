...
function VideoDetails({ data }) {
  ...
  return (
    <>
      ...
      <Header />
      <BreadCrumb title="Course Name" subtitle="My Courses" />

      <div>
        <div className="video_data">
          <div className="video_content">
            <ReactPlayer
              url="https://www.youtube.com/embed/Holv98J2eDM?si=6zduYGj2pJzu4JJx"
              controls={true}
              height="450px"
              width="750px"
            />
          ...
          <div className="video_title_data">
            <div className="more_video_section">
              <div className="video_content">
                <ReactPlayer
                  url="https://www.youtube.com/embed/Holv98J2eDM?si=6zduYGj2pJzu4JJx"
                  controls={true}
              ...
              <div className="main_video_title">
                <a
                  href="https://www.youtube.com/embed/Holv98J2eDM?si=6zduYGj2pJzu4JJx"
                  onClick={playVideo}
                >
                  Tutorial 1 data content
                </a>
                {videoVisible && (
                  <video width="700" height="450" controls>
                    <source
                      src="https://www.youtube.com/embed/Holv98J2eDM?si=6zduYGj2pJzu4JJx"
                      type="video/mp4"
                    />
                  </video>
                )}
        ...
        <ul className="nav nav-tabs" id="courseTab" role="tablist">
          <li className="nav-item" role="presentation">
            <button
              ...
              aria-selected="true"
            >
              <i className="fa-regular fa-medal"></i> <span>Description</span>{" "}
            </button>
          </li>
          {/* <li className="nav-item" role="presentation">
        ...
        <div className="tab-content" id="courseTabContent">
          ...
          >
            <div className="course__description">
              ...
              <div className="para">{ReactHtmlParser(data?.description)}</div>
            ...
            <a href="#">Data modeling</a>
              ...
              <div className="course__description-list mb-45">
                ...
                <ul>
                  {data?.topic_covered?.map((ele, i) => {
                    return (
                      <li key={i}>
                        {" "}
                        <i className="fa-solid fa-check"></i> {ele}
                      </li>
                    );
                  })}
                </ul>
